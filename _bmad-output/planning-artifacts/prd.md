...
- Epic 2 complete (all resume and education CRUD endpoints delivered). Epic 3 in progress: stories 3.1 (create) and 3.2 (list) complete; stories 3.3–3.5 (detail, update, delete) remaining. Phase B HTTP core is substantially complete with user profile, resume, education, and cover-letter-template create/list support.
