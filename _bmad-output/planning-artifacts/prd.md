...
- Epic 2 complete (all resume and education CRUD endpoints delivered). Epic 3 started with cover letter template creation (story 3.1). Phase B HTTP core is substantially complete with user profile, resume, education, and initial cover-letter-template support.
