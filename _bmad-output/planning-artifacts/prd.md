...
- Epic 2 complete (all resume and education CRUD endpoints delivered). Epic 3 in progress: stories 3.1 (create), 3.2 (list), and 3.3 (detail) complete; stories 3.4–3.5 (update, delete) remaining. Phase B HTTP core is substantially complete with user profile, resume, education, and cover-letter-template create/list/detail support.
